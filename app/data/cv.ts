...
export const cv = {
  ...
  experience: [
    ...
    },
    {
      ...
      intent: "Salvage usable mechanical and electrical components from two broken Ender 3s into an expanded 585 × 775 × 230 mm Cartesian platform for ~$16 in new material.",
      summary: "Salvaged usable mechanical and electrical parts from two broken Ender 3s, restructuring them into a working Cartesian printer with an expanded 585 × 775 × 230 mm build volume.",
      proof: "Physically built and demonstrated at Open Sauce as a printer and later as a plotter; logged ~64 hours build time on a ~$16 new material budget.",
      route: "/projects/ender3-2",
      dossier: {
        intent: "Expand Cartesian build volume using salvaged parts while ensuring mechanical stability and bed level calibration.",
        architecture: "Cartesian machine reconstruction combining salvaged extrusions, motors, leadscrews, and controller from two decommissioned Ender 3 printers into an expanded 585 × 775 × 230 mm platform. Custom live-editable firmware with a 12 × 18 bed probe mesh.",
        stack: ["Cartesian Mechanics", "Creality 4.2.2 Board", "Custom Firmware", "4040 Aluminum Extrusions", "Dual Lead Screws", "3D Printing & Plotter Tools"],
        metrics: [
          ...
          "Demonstrated live at Open Sauce maker festival as a large-format printer and plotter",
        ],
        keyDecisions: [
          ...
          "Converted completed platform into a plotter as the centerpiece of Open Sauce exhibition booth.",
        ],
    ...
    },
    {
      ...
      dossier: {
        ...
        keyDecisions: [
          ...
          "Adapted existing projects into interactive public demos (such as the Ender3-2 plotter) for engaging crowds at Open Sauce.",
