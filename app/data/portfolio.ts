...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    anchor: 0.28,
    number: "03",
    domain: "Research & Embedded Sensing",
    status: "Active Research · 90% Speaker Recognition",
  ...
  },
  {
    ...
    anchor: 0.42,
    number: "04",
    domain: "Systems Software & Machine Learning",
  ...
  },
  {
    ...
    status: "Design Study · V1 CAD Complete, V2 in Progress",
  ...
  },
  {
    ...
    anchor: 0.71,
    number: "06",
    domain: "Fabrication & Machine Design",
    status: "Built & Exhibited at Open Sauce",
    ...
    body: "Rebuilt two failed, basically e-waste Ender 3s into an expanded 585 × 775 × 230 mm Cartesian machine with custom Marlin firmware and a 12 × 18 dynamic bed leveling mesh.",
    records: [
      ...
      { label: "Exhibition", value: "Continuous multi-hour live operation at Open Sauce" },
    ],
    accent: "#e5b86b",
  ...
  },
  {
    ...
    anchor: 0.86,
    number: "07",
    domain: "Systems Leadership & Outreach",
...
export const projects: Record<ProjectKey, Project> = {
    ...
    beats: [
      {
        ...
        title: "Can acoustic pressure waves modulate commodity Wi‑Fi subcarriers?",
        ...
        body: "Sound waves induce microscopic surface vibrations in physical obstacles and antenna ground planes, altering RF signal propagation. While military radar or optical vibrometry achieves this with expensive lasers, this research evaluates whether sub-$5 ESP32-S3 and C6 microcontrollers can capture sufficient subcarrier phase and amplitude shifts to detect acoustic events and identify human speakers.",
  ...
  vulcan: {
    ...
    media: [
      { src: "/portfolio/media/vulcan-hero.webp", alt: "Vulcan V1 full robot-arm CAD render", caption: "Vulcan V1 full 6-axis CAD assembly", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/vulcan-detail.webp", alt: "Vulcan V1 alternate full-assembly CAD view", caption: "Arm articulation and joint geometry study", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/vulcan-assembly.webp", alt: "Vulcan V1 alternate assembly view", caption: "Counterbalanced shoulder geometry and differential wrist", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/vulcan-zine.jpg", alt: "Vulcan V1 technical zine", caption: "V1 technical documentation zine and assembly manual", ratio: "portrait", fit: "contain" },
    ],
  },
  "ender3-2": {
    key: "ender3-2",
    ...
    status: "Built & Exhibited at Open Sauce",
    deck: "A salvage-driven large-format Cartesian machine rebuilt from two failed, basically e-waste donor printers, scaled to an expanded 585 × 775 × 230 mm build envelope with custom firmware and demonstrated live in continuous operation at Open Sauce.",
    accent: "#e5b86b",
    repo: "https://github.com/StillPillWill/Ender3-2",
    ...
    beats: [
      {
        ...
        intent: "Reclaim functional extrusions, motors, and electronics from two broken, basically e-waste printers into an expanded build envelope.",
        body: "Standard desktop 3D printers have ~220 × 220 mm beds. Salvaging structural extrusions, leadscrews, stepper motors, and motion hardware from two discarded, basically e-waste Ender 3 units, I built an expanded Cartesian platform achieving a 585 × 775 × 230 mm build volume with $16 in new expenditure for timing belts and plywood.",
        facts: ["2 e-waste printers salvaged", "585 × 775 × 230 mm envelope", "$16 new material BOM", "Over 3× standard volume"],
        visual: "model",
      },
      {
      ...
      },
      {
        ...
        title: "Demonstrated live in continuous multi-hour operation at Open Sauce.",
        intent: "Validate mechanical reliability under continuous multi-hour public demonstration.",
        body: "At the Open Sauce maker festival in San Francisco, the rebuilt machine operated live as a working centerpiece throughout the event. Over multiple hours of continuous exhibition for hundreds of attendees, the enlarged platform maintained calibration and motion reliability without structural or thermal failure.",
        facts: ["Open Sauce exhibitor", "Multi-hour continuous demo", "Zero mechanical failures", "Public reliability test"],
        visual: "media",
      },
    ],
    media: [
      { src: "/portfolio/media/ender3-2/printing-motion.mp4", alt: "Ender3-2 running a large-format boat print", caption: "Completed Cartesian machine printing in workshop", ratio: "portrait", fit: "contain", kind: "video" },
      { src: "/portfolio/media/ender3-2/machine-in-operation.webp", alt: "Ender3-2 printing a large multicolor boat", caption: "Oversized multicolor print on 585 × 775 mm bed", ratio: "portrait", fit: "contain" },
      { src: "/portfolio/media/ender3-2/full-build.webp", alt: "Full Ender3-2 machine and oversized build surface", caption: "Assembled frame with extended 4040 aluminum extrusions", ratio: "portrait", fit: "contain" },
      { src: "/portfolio/media/ender3-2/boat-print.webp", alt: "Large boat print on Ender3-2", caption: "Scale comparison on expanded build platform", ratio: "portrait", fit: "contain" },
      { src: "/portfolio/media/ender3-2/assembly-stage.webp", alt: "Ender3-2 during physical assembly", caption: "Frame and dual lead-screw assembly in workshop", ratio: "portrait", fit: "contain" },
    ],
  },
  "team-3598": {
    key: "team-3598",
    ...
    media: [
      { src: "/portfolio/media/team3598.webp", alt: "Full Team 3598 group", caption: "Team 3598 students, mentors, and competition robot", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/team3598/competition-crowd.webp", alt: "Team 3598 students at competition", caption: "Drive team and pit crew at regional competition", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/team3598/outreach-reach.webp", alt: "Team 3598 outreach record", caption: "Regional STEM outreach summary across Sacramento", ratio: "wide", fit: "contain" },
      { src: "/portfolio/media/team3598/team-identity.webp", alt: "Team 3598 identity and location record", caption: "Team 3598 identity and program record", ratio: "portrait", fit: "contain" },
    ],
  },
};
