...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    intent: "Maintain full-stack hardware-software competency spanning assembly, firmware, ML pipelines, and precision CAD/shop tooling.",
  ...
  },
  {
    ...
    intent: "Tackle high-constraint algorithmic problems ranging from bare-metal interrupt service routines to 3D medical diagnostics.",
    ...
    beats: [
      {
        ...
        body: "Traditional six-axis robot arms rely on expensive precision gearboxes requiring tight manufacturing tolerances. Vulcan V1 was conceived as an open-source mechanical architecture engineered around standard NEMA steppers, off-the-shelf timing belts, and 3D-printable structural parts, allowing makers and students to build a full 6-DOF manipulator without industrial CNC access.",
  ...
  "ender3-2": {
    ...
    beats: [
      ...
      },
      {
        ...
        intent: "Maintain structural rigidity across an expanded Cartesian motion envelope using salvaged and reinforced hardware.",
  ...
  "team-3598": {
    ...
    beats: [
      ...
      },
      {
        ...
        intent: "Maintain technical alignment across mechanical, electrical, software, operations, and outreach subteams during intense competition seasons.",
      ...
      },
      {
        ...
        intent: "Train and upskill student team members in engineering fundamentals, shop safety, and modern software tools.",
      ...
      },
      {
        ...
        intent: "Lead the team to top-tier competitive execution and regional recognition.",
        body: "Under this leadership framework, Team 3598 competed across three events, advanced to the district championship, qualified for the FIRST World Championship, and earned the FIRST Impact Award—the organization's highest honor celebrating engineering sustainability and community culture.",
      ...
      },
      {
        ...
        body: "Spearheaded community engineering initiatives including hands-on robotics workshops, public library exhibitions, school visits, demonstrations, and community partnerships that reached 4,452 students across the greater Sacramento region.",
