  ...
  csi: {
    ...
    beats: [
      ...
      },
      {
        ...
        body: "The prototype demonstrated reliable audio-event detection and 90% speaker identification from captured CSI across 122 training runs and 400 hours of compute. The findings demonstrate acoustic sensing feasibility while keeping claims rigorously grounded.",
